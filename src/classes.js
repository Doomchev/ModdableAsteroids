...
export let classes = {
    ...
    Sprite: function(o) {return new Sprite(o.name, o.image, o.centerX, o.centerY, o.width, o.height, o.angleInDegrees, o.speed, o.imageAngle)},
    Key: function(o) {return new Key(o.name, o.code)},
    ...
    ImageArray: function(o) {return new ImageArray(o.name, o.texture, o.columns, o.rows, o.xMul, o.yMul, o.widthMul, o.heightMul)},
    ...
    Layer: function(o) {return new Layer(o.name, o.items)},
    ...
    Canvas: function(o) {return new Canvas(o.fx, o.fy, o.fwidth, o.fheight, o.scale, o.active)},
    ...
    Shape: function(o) {return new Shape(o.name, o.centerX, o.centerY,  o.width, o.height)},
    ...
    IntVariable: function(o) {return new IntVariable(o.name, o.value, o.format)},
    Increment: function(o) {return new Increment(o.variable)},
    EnumVariable: function(o) {return new EnumVariable(o.name, o.value)},
    ...
    SpriteVariable: function(o) {return new SpriteVariable(o.name)},
