...
import {rad, randomSign, rnd} from "../src/system.js"
...
export default class DefaultAsteroidCreation extends Mod {
    ...
    init() {
        val.createAsteroid = function (centerX, centerY, type, piece, angle = 0) {
            let asteroid = Sprite.create(undefined, pobj.asteroids, pobj.asteroidImages, centerX, centerY
